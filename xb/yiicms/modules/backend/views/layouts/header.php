...
<header class="main-header">
   ...
   <?= Html::a('<span class="logo-mini">CMS</span><span class="logo-lg">' . Yii::$app->name . '后台</span>', ['/backend/'], ['class' => 'logo']) ?>-->
    <?= Html::a('<img  src="/../images/logo.png"/>', ['/backend/'], ['class' => 'logo hidden-xs']) ?>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs fa fa-user"><?=isset(Yii::$app->user->identity->username)? ' '.Yii::$app->user->identity->username:''?></span>
                    </a>
...
<!--                         Menu Footer-->
                ...
                <li>
                    <a href="<?=Url::to(['/backend/default/edit-password'])?>" class="fa fa-cog"> 修改密码</a>
                </li>
                <li>
                    <?= Html::a(
                                    ' 退出',
